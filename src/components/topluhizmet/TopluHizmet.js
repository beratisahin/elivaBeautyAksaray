  ...
  handleChange(e) {
    ...
    this.setState({
      kampanyaAd: encodeURI(
        `https://wa.me/++905011481755?text=${e.target.value}`
      ),
    });
  }
      ...
      >
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <Taslak
            ...
            taslakphoto={m5}
            taslaktext="Samsun Titanyum Beauty Salonu olarak siz değerli müşterilerimize lazer epilasyon, cilt bakımı ve bölgesel incelme vb alanlarda hizmet vermekteyiz."
